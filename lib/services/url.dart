...
class ApiUrl {
  ...
  static String registerUrl = '$baseUrl/app-register';

  static String bannerUrl = '$baseUrl/banner';
...
static String deleteEstimate= '$baseUrl/estimate/destroy';
 ...
 static String adddeliveryAddressUrl = '$baseUrl/delivery-address/create';
  ...
  static String orderListUrl = '$baseUrl/order/list';

  static String trendingPopupUrl = '$baseUrl/trending-offers/get-pop-up';

  static String CoupanListUrl = '$baseUrl/my-coupons';
